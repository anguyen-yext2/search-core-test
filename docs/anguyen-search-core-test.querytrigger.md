...
[Home](./index.md) &gt; [anguyen-search-core-test](./anguyen-search-core-test.md) &gt; [QueryTrigger](./anguyen-search-core-test.querytrigger.md)
...
Indicates that the query was suggested by a [SpellCheck](./anguyen-search-core-test.spellcheck.md) response.
