...
[Home](./index.md) &gt; [@anguyen-yext2/search-core-test](./search-core-test.md) &gt; [QueryTrigger](./search-core-test.querytrigger.md)
...
Indicates that the query was suggested by a [SpellCheck](./search-core-test.spellcheck.md) response.
